 ...
 * Author: whyang
 */
public class OrderWaitingFragment extends BaseFullFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, OrderAdapter.orderOperateListener, PayDialog.payClickListener {
    @BindView(R.id.id_waiting_listview)
