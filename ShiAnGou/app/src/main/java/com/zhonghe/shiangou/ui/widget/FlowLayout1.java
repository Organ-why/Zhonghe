...
public class FlowLayout1 extends ViewGroup {
    ...
    public FlowLayout1(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (this.config.getOrientation() == FlowLayout1.HORIZONTAL) {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        void clearCalculatedFields(int orientation) {
            if (orientation == FlowLayout1.HORIZONTAL) {
