 ...
 * Author: whyang
 */
public class OrderUnRemarkFragment extends BaseFullFragment implements PullToRefreshBase.OnRefreshListener2<ListView>, OrderAdapter.orderOperateListener, PayDialog.payClickListener {
    @BindView(R.id.id_unremark_listview)
    ...
    protected void initLayout() {
        setContentView(R.layout.fragment_unremark);
