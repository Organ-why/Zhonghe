...
class LayoutConfiguration {
    private int orientation = FlowLayout1.HORIZONTAL;
    ...
    public LayoutConfiguration(Context context, AttributeSet attributeSet) {
        ...
        try {
            this.setOrientation(a.getInteger(R.styleable.FlowLayout_android_orientation, FlowLayout1.HORIZONTAL));
            ...
            this.setLayoutDirection(a.getInteger(R.styleable.FlowLayout_flowDirection, FlowLayout.LAYOUT_DIRECTION_LTR));
        } finally {
            a.recycle();
        }
    }
    ...
    public void setOrientation(int orientation) {
        if (orientation == FlowLayout1.VERTICAL) {
            this.orientation = orientation;
        } else {
            this.orientation = FlowLayout1.HORIZONTAL;
        }
    }
