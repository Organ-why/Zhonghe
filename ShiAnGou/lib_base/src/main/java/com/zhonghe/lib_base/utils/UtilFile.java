...
import com.zhonghe.lib_base.constant.CstCharset;
...
public class UtilFile {
     ...
     * @return true：字符串写入成功， false：字符串写入失败
     */
     ...
     * 将源文件拷贝到指定的路径
     *
     * @param source 源文件(绝对路径）
     * @param dest   目标文件(绝对路径）
     * @return true:文件拷贝到指定路径，false：文件拷贝失败
     */
     ...
     *
     * @param filePath 文件路径（绝对路径）
     * @return true:指定的文件存在，false：指定的文件不存在
     */
     ...
     * @return true:指定的文件夹存在，false：指定的文件夹不存在
     */
